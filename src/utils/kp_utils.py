...
def get_common_insta_joint_names():
    return [
        'OP RAnkle',    # 0  "lankle",    # 0
        'OP RKnee',     # 1  "lknee",     # 1
        'OP RHip',      # 2  "lhip",      # 2
        'OP LHip',      # 3  "rhip",      # 3
        'OP LKnee',     # 4  "rknee",     # 4
        'OP LAnkle',    # 5  "rankle",    # 5
        'OP RWrist',    # 6  "lwrist",    # 6
        'OP RElbow',    # 7  "lelbow",    # 7
        'OP RShoulder', # 8  "lshoulder", # 8
        'OP LShoulder', # 9  "rshoulder", # 9
        'OP LElbow',    # 10  "relbow",    # 10
        'OP LWrist',    # 11  "rwrist",    # 11
        'OP Neck',      # 12  "neck",      # 12
